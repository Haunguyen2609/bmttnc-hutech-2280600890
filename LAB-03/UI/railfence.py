...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_plain_text.setGeometry(QtCore.QRect(140, 70, 621, 71))
        ...
        self.label_3.setGeometry(QtCore.QRect(280, 20, 281, 21))
        font = QtGui.QFont()
        ...
        self.txt_key.setGeometry(QtCore.QRect(140, 230, 621, 71))
        self.txt_key.setObjectName("txt_key")
        self.btn_decrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_decrypt.setGeometry(QtCore.QRect(550, 500, 75, 23))
        self.btn_decrypt.setObjectName("btn_decrypt")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(60, 370, 61, 16))
        self.label_4.setObjectName("label_4")
        self.txt_cipher_text = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_cipher_text.setGeometry(QtCore.QRect(140, 350, 621, 71))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "RAILFENCE CIPHER"))
